...
namespace redflyDatabaseAdapters
{
    public class MongoDbPicker
    {
        ...
        public static bool GetFromUser()
        {
            ...
            AppDbSession.MongoDatabase = SaveDatabaseDetailsToLocalStorage(serverName, databaseName, userName, password);

            return (AppDbSession.MongoDatabase != null);
        }
        ...
        public static bool SelectFromLocalStorage()
        {
            ...
            else
            {
                ...
                AppDbSession.MongoDatabase = all.ElementAt(selectedIndex - 1);
                return true;
            }
        }
