...
public class SalesLTProductCategory : BaseTableEntity
{
...
public class SalesLTProductCategoryDataSource : BaseTableDataSource<SalesLTProductCategory>
{
    ...
    protected override SalesLTProductCategory MapRowToTableEntity(Row row)
    {
        ...
        return new SalesLTProductCategory
        {
            ...
            ParentProductCategoryId = dict.TryGetValue("ParentProductCategoryID", out var v2) && !string.IsNullOrEmpty(v2) && int.TryParse(v2, out var i2) ? i2 : (int?)null,
