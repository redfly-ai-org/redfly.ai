...
public class SalesLTSalesOrderHeaderDataSource : BaseTableDataSource<SalesLTSalesOrderHeader>
{
    ...
    protected override SalesLTSalesOrderHeader MapRowToTableEntity(Row row)
    {
        ...
        return new SalesLTSalesOrderHeader
        {
            ...
            ShipDate = dict.TryGetValue("ShipDate", out var v5) && !string.IsNullOrEmpty(v5) && DateTime.TryParse(v5, out var d5) ? d5 : (DateTime?)null,
            ...
            ShipToAddressId = dict.TryGetValue("ShipToAddressID", out var v12) && !string.IsNullOrEmpty(v12) && int.TryParse(v12, out var i12) ? i12 : (int?)null,
            BillToAddressId = dict.TryGetValue("BillToAddressID", out var v13) && !string.IsNullOrEmpty(v13) && int.TryParse(v13, out var i13) ? i13 : (int?)null,
