...
public class SalesLTSalesOrderHeaderDataSource : TableDataSourceBase<SalesLTSalesOrderHeader>
{
    ...
    protected override SalesLTSalesOrderHeader MapRowToTableEntity(Row row)
    {
        ...
        return new SalesLTSalesOrderHeader
        {
            ...
            ShipToAddressId = dict.TryGetValue("ShipToAddressID", out var v12) && !string.IsNullOrEmpty(v12) ? (int)Convert.ChangeType(v12, typeof(int)) : null,

            BillToAddressId = dict.TryGetValue("BillToAddressID", out var v13) && !string.IsNullOrEmpty(v13) ? (int)Convert.ChangeType(v13, typeof(int)) : null,
    ...
    protected override Row MapTableEntityToRow(SalesLTSalesOrderHeader entity, DbOperationType dbOperationType)
    {
        ...
        row.Entries.Add(new RowEntry { Column = "ShipToAddressID", Value = new Value { StringValue = entity.ShipToAddressId != null ? entity.ShipToAddressId.ToString() : null } });
        row.Entries.Add(new RowEntry { Column = "BillToAddressID", Value = new Value { StringValue = entity.BillToAddressId != null ? entity.BillToAddressId.ToString() : null } });
