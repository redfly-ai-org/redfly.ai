...
// redfly SqlServerGrpcPolyLangCompiler on 05/24/25 10:33:21 PM
...
public class SalesLTProductDataSource : BaseTableDataSource<SalesLTProduct>
{
    ...
    protected override SalesLTProduct MapRowToTableEntity(Row row)
    {
        ...
        return new SalesLTProduct
        {
            ...
            Weight = dict.TryGetValue("Weight", out var v8) && !string.IsNullOrEmpty(v8) && decimal.TryParse(v8, out var d8) ? d8 : (decimal?)null,
            ProductCategoryId = dict.TryGetValue("ProductCategoryID", out var v9) && !string.IsNullOrEmpty(v9) && int.TryParse(v9, out var i9) ? i9 : (int?)null,
            ProductModelId = dict.TryGetValue("ProductModelID", out var v10) && !string.IsNullOrEmpty(v10) && int.TryParse(v10, out var i10) ? i10 : (int?)null,
            SellStartDate = dict.TryGetValue("SellStartDate", out var v11) && DateTime.TryParse(v11, out var d11) ? d11 : DateTime.MinValue,
            SellEndDate = dict.TryGetValue("SellEndDate", out var v12) && !string.IsNullOrEmpty(v12) && DateTime.TryParse(v12, out var d12) ? d12 : (DateTime?)null,
            DiscontinuedDate = dict.TryGetValue("DiscontinuedDate", out var v13) && !string.IsNullOrEmpty(v13) && DateTime.TryParse(v13, out var d13) ? d13 : (DateTime?)null,
    ...
    protected override Row MapTableEntityToRow(SalesLTProduct entity, DbOperationType dbOperationType)
    {
        ...
        if (entity.ProductCategoryId != null)
        {
            row.Entries.Add(new RowEntry { Column = "ProductCategoryID", Value = new Value { StringValue = entity.ProductCategoryId.ToString() } });
        }
        else
        {
            row.Entries.Add(new RowEntry { Column = "ProductCategoryID", Value = new Value { StringValue = null } });
        }
