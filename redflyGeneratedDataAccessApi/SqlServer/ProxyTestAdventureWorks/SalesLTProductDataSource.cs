...
public class SalesLTProduct : BaseSqlServerTableSchema
{
...
public class SalesLTProductDataSource : BaseSqlServerTableDataSource<SalesLTProduct>
{
    ...
    protected override SalesLTProduct MapRowToTableEntity(Row row)
    {
        ...
        return new SalesLTProduct
        {
            ...
            Weight = dict.TryGetValue("Weight", out var v8) && !string.IsNullOrEmpty(v8) && decimal.TryParse(v8, out var d8) ? d8 : null,
            ProductCategoryId = dict.TryGetValue("ProductCategoryID", out var v9) && !string.IsNullOrEmpty(v9) && int.TryParse(v9, out var i9) ? i9 : null,
            ProductModelId = dict.TryGetValue("ProductModelID", out var v10) && !string.IsNullOrEmpty(v10) && int.TryParse(v10, out var i10) ? i10 : null,
            SellStartDate = dict.TryGetValue("SellStartDate", out var v11) && DateTime.TryParse(v11, out var d11) ? d11 : DateTime.MinValue,
            SellEndDate = dict.TryGetValue("SellEndDate", out var v12) && !string.IsNullOrEmpty(v12) && DateTime.TryParse(v12, out var d12) ? d12 : null,
            DiscontinuedDate = dict.TryGetValue("DiscontinuedDate", out var v13) && !string.IsNullOrEmpty(v13) && DateTime.TryParse(v13, out var d13) ? d13 : null,
