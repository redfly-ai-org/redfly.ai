...
public class ErrorLogDataSource : BaseTableDataSource<ErrorLog>
{
    ...
    protected override ErrorLog MapRowToTableEntity(Row row)
    {
        ...
        return new ErrorLog
        {
            ...
            ErrorSeverity = dict.TryGetValue("ErrorSeverity", out var v5) && !string.IsNullOrEmpty(v5) && int.TryParse(v5, out var i5) ? i5 : (int?)null,
            ErrorState = dict.TryGetValue("ErrorState", out var v6) && !string.IsNullOrEmpty(v6) && int.TryParse(v6, out var i6) ? i6 : (int?)null,
            ErrorProcedure = dict.TryGetValue("ErrorProcedure", out var v7) ? v7 : null,
            ErrorLine = dict.TryGetValue("ErrorLine", out var v8) && !string.IsNullOrEmpty(v8) && int.TryParse(v8, out var i8) ? i8 : (int?)null,
